...
Upon studying the comparative analysis of performative algorithms (refer to table \ref{table:OptCmp}), the main elements affecting the choice of algorithm would be as follows.
