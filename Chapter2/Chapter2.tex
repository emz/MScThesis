...
However, up to this point only the fact that computers can create models of shapes and geometry has been proven; the capability of producing `\emph{design}' remains a completely different matter, which is the subject of the following chapter; discussing \emph{rule-based} design, and performative optimizational systems.
